...
def draw():
    ...
    if invasions >= game_over_invasions:
        screen.blit('stars', (0, 0))
        draw_score()
        screen.draw.text("Game Over", (277, HEIGHT / 2))
        return
...
def draw_score():
    ...
    screen.draw.text("score={}, invasions={}".format(score, invasions), (10, HEIGHT - 30))           
